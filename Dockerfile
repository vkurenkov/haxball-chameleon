...
RUN conda create -q -n -y py2 python=2.7 mkl numpy scipy scikit-learn jupyter notebook ipython pandas matplotlib
RUN conda create -q -n -y py3 python=3 mkl numpy scipy scikit-learn jupyter notebook ipython pandas matplotlib
