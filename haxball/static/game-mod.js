...
const exposed = (function (qc) {
    ...
    function Wb(a) {
        ...
        window.timer.requestAnimationFrame(G(this, this.af));
    ...
    Jb.prototype = C(V.prototype, {
        ...
        C: function () {
            var a = window.performance.now(), b = a - this.Uh;
            this.Uh = a;
    ...
    ca.prototype = {
        ...
        ia: function () {
            ...
            window.timer.cancelAnimationFrame(this.Ce);
            this.nb.ia();
        ...
        af: function () {
            this.Ce = window.timer.requestAnimationFrame(G(this, this.af));
            this.nb.C();
            this.ya.C();
            this.Jc();
        },
    ...
    return (() => {
        const $_GameState = ga;
        const $_BaseNetGameController = V;
        ...
        forward($_BaseNetGameController, 'td', 'Fd');
        forward($_BaseNetGameController, 'Mg', 'jh');
        forward($_BaseNetGameController, 'Te', 'lf');
        forward($_BaseNetGameController, 'v', 'C');

        forward($_BaseNetGameController, 'L', 'T');
        forward($_BaseNetGameController, 'vc', 'Ac');
        forward($_BaseNetGameController, 'S', 'X');
